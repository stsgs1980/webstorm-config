export default {
  meta: {
    ...
    messages: { missingLanguage: "Code block must specify a language. Use 'text' or 'bash' if unknown." },
  },
  create(context) {
    ...
    return {
      Program() {
        ...
        lines.forEach((line, index) => {
          ...
          if (!insideCodeBlock) {
            if (afterFence.trim() === "") {
              context.report({ loc: { line: index + 1, column: 0 }, messageId: "missingLanguage" });
            }
